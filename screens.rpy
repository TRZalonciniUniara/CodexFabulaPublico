...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Savar") action ShowMenu('save')
            textbutton _("Q.Savar") action QuickSave()
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Página {}"), auto=_("Salvamento Automático"), quick=_("Salvamento Rápido"))
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Esquerdo") action Preference("rollback side", "left")
                    textbutton _("Direito") action Preference("rollback side", "right")
...
screen keyboard_help():
    ...
    hbox:
        label _("Ctrl")
        text _("Pula os diálogos enquanto pressionada.")

    hbox:
        label _("Tab")
        text _("Alterna o pular de diálogo.")
    ...
    hbox:
        label _("Page Down")
        text _("Avança ao próximo diálogo.")
    ...
    hbox:
        label "S"
        text _("Reproduz uma imagem da tela, Screenshot.")

    hbox:
        label "V"
        text _("Alterna o assistente {a=https://www.renpy.org/l/voicing}de auto-vocalização{/a}.")
...
screen mouse_help():
    ...
    hbox:
        ...
        text _("Avança o diálogo e interage com a interface.")

    hbox:
        label _("Botão Central/Pressionar da Roda")
    ...
    hbox:
        label _("Rolar a roda do mouse para cima")
        text _("Retorna à um diálogo anterior.")

    hbox:
        label _("Rolar a roda do mouse para baixo")
        text _("Avança à um diálogo posterior.")
